...
class FrontPage extends Component {
    ...
    handleChangeU1=()=>{
     ...
     //   console.log(`https://api.github.com/users/${this.state.usr__1}`)
            ...
            axios.get(`https://api.github.com/users/${this.state.usr__1}/repos`)
            .then(response=>{
                console.log(response)
                this.setState({
    ...
    //  console.log("called")
             ...
             axios.get(`https://api.github.com/users/${this.state.usr__2}/repos`)
             .then(response=>{
                 console.log(response)
                 this.setState({
    ...
    render() {
        const {usr__1,usr__2, count_1,count_2,usr__1__imgSrc,usr__2__imgSrc, no_of_repos_1 , no_of_followers_1, no_of_gists_1,no_of_repos_2 , no_of_followers_2, no_of_gists_2} = this.state
        ...
        return (
            ...
            {/* no_of_followers:response.data.followers,
                ...
                <Contact />
            <div id="comp"> 
                <Comparer repos_1={no_of_repos_1} follower_1={no_of_followers_1} gists_1={no_of_gists_1} repos_2={no_of_repos_2} follower_2={no_of_followers_2} gists_2={no_of_gists_2} usr_1={usr__1__imgSrc} usr_2={usr__2__imgSrc} star_1={count_1} star_2={count_2}   />
             </div> 
            </div>
        )
    }
